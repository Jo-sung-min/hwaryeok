...
export function buildSkinCareGuide(profile: SkinCareInput) {
  ...
  const ingredients = [
    { name: "히알루론산", role: "수분 보습", reason: dry ? "속당김이 신경 쓰인다면 수분 보습 성분으로 먼저 살펴보세요." : "산뜻한 보습 제품을 찾을 때 확인해 볼 수분 성분이에요." },
    { name: "세라마이드", role: "보습 유지", reason: combination ? "특히 건조하게 느껴지는 부위에 쓸 보습제를 고를 때 살펴보세요." : dry ? "촉촉함이 오래가는 보습제를 찾을 때 함께 살펴볼 성분이에요." : "피부의 편안한 보습을 유지할 제품에서 함께 확인해 보세요." },
  ];
