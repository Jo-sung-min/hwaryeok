...
createServer(async (req, res) => {
  ...
  const content = photo ? `<div class="page"><header class="header"><div class="identity"><p class="eyebrow">MY SKIN PHOTO</p><h1>사진 피부 분석</h1><p>가상 피부기록님의 피부를 조금 더 자세히.</p></div></header><nav class="tabs"><a href="/">내 기록</a><a href="/photo" aria-current="page">사진 피부 분석 AI</a></nav>${photoForm({ enabled: false, dailyLimit: 3, remaining: 3 })}</div>` : await dashboard();
